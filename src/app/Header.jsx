...
function Header() {
    return (
        <header>
            <nav className="flex items-center justify-between xl:max-w-screen-xl mx-auto py-3">
                <div className="">
                ...
                <div >
                    <ul className="flex">
                        <li className="px-4 text-gray-7 hover:text-primary hover:font-medium">
                            <Link href="/">
                                صفحه اصلی
                            </Link>
                        </li>
                        <li className="px-4 text-gray-7">
                            <Link href="/">
                                شعبه
                            </Link>
                        </li>
                ...
                <div className="flex items-center justify-between">
                    ...
                    {/* search icon */}
                    <div className="bg-tint-1 p-2 ml-2 rounded-md">
                        <Link href="/">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="#417f56" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="bg-tint-1 p-2 ml-2 rounded-md">
                        <Link href="/">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="#417f56" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_4418_7224)">
